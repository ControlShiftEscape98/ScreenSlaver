...
description: "AI-Powered Design Intelligence for Gorgeous, Modern UIs. Use this skill to design and build websites, ensuring a consistent framework consisting of Pattern, Style, Color, Typography, and Animation."
---
...
When a user asks to design, build, or create a website/UI using this skill, you MUST ask them the following 5 questions (unless they have already provided the answers). These are the 5 Core Dimensions needed to build the UI:

1. **PATTERN & LAYOUT (The Skeleton):**
   *What functional pattern based on your product type should we use? (See Dimension 1 below)*
2. **STYLE & AESTHETIC (The Skin):**
   *What is the overarching visual style? (See Dimension 2 below)*
3. **COLOR & THEME (The Palette):**
   *What is the emotional tone / color psychology? (See Dimension 3 below)*
4. **TYPOGRAPHY (The Voice):**
   *What font pairings match your brand voice? (See Dimension 4 below)*
5. **ANIMATIONS & INTERACTIONS (The Soul):**
   *What interactions/micro-interactions should we include? (See Dimension 5 below)*

Once you have gathered these 5 dimensions from the user, you may proceed with the design using the guidelines below.
